...
If you'd like to hide specific warehouses from SnowKill, then you will need to `grant monitor,usage,operate on warehouse X to role Y;` for each individual warehouse you'd like SnowKill to be able to look at.
